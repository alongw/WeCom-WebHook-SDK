...
export type WeComNewsOptions = {
    ...
    news: {
        articles: Array<{
            ...
            url: string
            picurl?: string // Recommended size: 1068x455, min 150x150
        }>
    }
}
...
type HorizontalContent =
    | (HorizontalContentBase & { type?: never; value?: string })
    | HorizontalContentUrl
    | HorizontalContentFile
    | HorizontalContentUserDetail
 ...
 */
export type WeComMessageConfig =
    | WeComTextOptions
    | WeComMarkdownOptions
    | WeComImageOptions
    | WeComNewsOptions
    | WeComFileOptions
    | WeComVoiceOptions
    | WeComTextCardOptions
    | WeComNewsNoticeCardOptions

export type WeComMessagePayloadMap = {
    [T in WeComMessageConfig['msgtype']]: Omit<
        Extract<WeComMessageConfig, { msgtype: T }>,
        'msgtype'
    >
}
